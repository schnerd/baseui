...
storiesOf('Button', module)
  ...
  .add('Secondary (Compact)', () => <ButtonSample $compact $secondary />)
  .add('Tertiary', () => <ButtonSample $tertiary />)
  .add('Tertiary (Compact)', () => <ButtonSample $compact $tertiary />)
  .add('Minimal', () => <ButtonSample $minimal />)
  .add('Minimal (Compact)', () => <ButtonSample $compact $minimal />)
