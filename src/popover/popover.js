...
import BaseUiComponent from '../helpers/base-ui-component';
...
class Popover extends BaseUiComponent<PopoverProps, PopoverPrivateState> {
  static defaultProps = {
    components: {},
  ...
  renderPopover() {
    ...
    return this.renderInternal(
      ...
      [
        showArrow
          ? this.renderInternal('PopoverArrow', {
              key: 'popover-arrow',
              $ref: this.arrowRef,
              ...sharedProps,
            })
